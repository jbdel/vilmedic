...
def a_star_generate(
    ...
    **model_specific_kwargs
    ...
    Parameters:
        ...
        encoder_hidden_states (`optional`) obj: `torch.LongTensor`
            Encoder hidden states.

        encoder_attention_mask (`optional`) obj: `torch.LongTensor` of same shape as `encoder_hidden_states`
...
def _generate_beam_search(
    ...
    while cur_len < max_length:
        ...
        # TODO: is it `batch_size * num_beams` or just `batch_size`?
        next_token_logits = outputs["logits"][:, -1, :]  # (batch_size * num_beams, cur_len, vocab_size) -> (batch_size * num_beams, vocab_size)
        ...
        ### CVU 06/03/2023 ###
        # TODO: don't think I need to do anything here? https://github.com/huggingface/transformers/issues/5134
